                ...
                <td>
                  ...
                  <template v-if="categoria.condicion">
                    <button
                      ...
                      @click="desactivarCategtoria(categoria.id)"
                    >
                      <i class="icon-trash"></i>
                    </button>
                  </template>
                  <template v-else>
                    <button class="btn btn-info btn-sm" @click="activarCategtoria(categoria.id)">
            ...
            <form action method="post" enctype="multipart/form-data" class="form-horizontal">
              ...
              <div v-show="errorCategoria" class="form-group row div-error">
                <div class="text-center text-error">
                  <div v-for="error in errorMostrarMsjCategoria" v-text="error" :key="error"></div>
                </div>
              </div>
            </form>
          </div>
  ...
  methods: {
    ...
    desactivarCategtoria(id) {
      ...
      swalWithBootstrapButtons
        .fire({
          title: "¿Estás segura de desactivar esta categoría?",
          type: "warning",
